...
from elasticsearch7.helpers import test
from elasticsearch7.helpers.test import ElasticsearchTestCase as BaseTestCase
...
def get_client(**kwargs):
    ...
    try:
        from test_elasticsearch7.local import get_client as local_get_client
