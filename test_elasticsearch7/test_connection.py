...
from elasticsearch7.exceptions import (
    TransportError,
    ConflictError,
    RequestError,
    NotFoundError,
)
from elasticsearch7.connection import (
    Connection,
    RequestsHttpConnection,
    Urllib3HttpConnection,
)
from elasticsearch7 import __versionstr__
...
class TestUrllib3Connection(TestCase):
    ...
    @patch("elasticsearch7.connection.base.logger")
...
class TestRequestsConnection(TestCase):
    ...
    @patch("elasticsearch7.connection.base.tracer")
    @patch("elasticsearch7.connection.base.logger")
