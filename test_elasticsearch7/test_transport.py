...
from elasticsearch7.transport import Transport, get_host_info
from elasticsearch7.connection import Connection
from elasticsearch7.connection_pool import DummyConnectionPool
...
class TestTransport(TestCase):
    ...
    @patch("elasticsearch7.transport.Transport.sniff_hosts")
